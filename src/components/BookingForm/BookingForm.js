...
export const BookingForm = ({ availableTimes, dispatch, date: dateState, time: timeState,
    ...
    return (
        <form className="booking-form" aria-label="Restaurant reservation form" noValidate onSubmit={handleSubmit}>
            ...
            <input type="submit" aria-label="On Click" value="Make Your reservation" className="highlight-text-font" />
            <input type="button" aria-label="On Click" value="Cancel" className="highlight-text-font" onClick={
                () => { navigate("/") }
            } />
        </form>
    )
